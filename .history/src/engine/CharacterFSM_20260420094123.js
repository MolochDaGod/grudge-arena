  ...
  const machine = createMachine(
    ...
    },
    {
      actions: {
        ...
        playAttack1: () => {
          char.fadeToAction("attack1", 0);
          char.onAttack?.(1);
        },
        playAttack2: () => {
          char.fadeToAction("attack2", 0);
          char.onAttack?.(2);
        },
        playAttack3: () => {
          char.fadeToAction("attack3", 0);
          char.onAttack?.(3);
        },
        playHeavy: () => {
          char.fadeToAction("heavy", 0);
          char.onAttack?.("heavy");
        },
        playSkill: () => char.onSkill?.(),
        playJump: () => char.fadeToAction("jump"),
        doJump: () => char.body?.jump(5.2),
        playFall: () => char.fadeToAction("fall", 0.3),
        playAirAttack: () => {
          char.fadeToAction("attack1", 0);
          char.onAttack?.("air");
        },
        playDash: () => {
          char.fadeToAction("dodge", 0);
        ...
        playHit: () => {
          char.fadeToAction("hit", 0);
          char.onHit?.();
        },
        playDead: () => {
          char.fadeToAction("death", 0);
          char.onDeath?.();
        },
      },
      guards: {
