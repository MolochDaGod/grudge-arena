...
export const WeaponDefinitions = {
  ...
  [WeaponTypes.SABRES]: {
    ...
    abilities: {
      ...
      P: { name: 'Shadow Dance', description: 'Ultimate: Reset all cooldowns and gain 50% attack speed.', cooldown: 90, cost: 0, costType: null, duration: 10, effect: 'reset_cooldowns', skillAnim: 'powerUp' }
    }
  },
  [WeaponTypes.SCYTHE]: {
  ...
  [WeaponTypes.RUNEBLADE]: {
    ...
    abilities: {
      ...
      R: { name: 'Judgment', description: 'Holy beam dealing damage and healing allies it passes.', cooldown: 6, cost: 50, costType: 'mana', damage: 80, healAmount: 50, width: 2, range: 15, effect: 'beam', skillAnim: 'cast' },
