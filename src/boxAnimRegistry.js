...
export const BOX_ANIM_GLOBAL = {
  ...
  blockHit: "boxanimations/reactions/Standing Block React Large",
  ...
  // Mixamo swim family (public/anims/baked/locomotion/* from bake-swim-mixamo.mjs)
  swim: "locomotion/swimming",
  swimIdle: "locomotion/treading-water",
  swimToLedge: "locomotion/swimming-to-ledge",
  treadingWater: "locomotion/treading-water",
  swimmingToEdge: "locomotion/swimming-to-ledge",
};
...
export const BOX_ANIM_BY_PACK = {
  sword_shield: {
    ...
    attack3: "boxanimations/sword_shield/Two Hand Sword Combo (1)",
  ...
  magic: {
    ...
    attack1: "boxanimations/sword_shield/Great Sword Casting (3)",
  },
  longbow: {
    attack1: "boxanimations/locomotion/Standing Aim Recoil (1)",
    draw: "boxanimations/longbow/Standing Draw Arrow (1)",
    aimIdle: "boxanimations/locomotion/Standing Aim Idle 02 Looking",
  ...
  unarmed: {
    ...
    combo1: "boxanimations/sword_shield/One Hand Sword Combo",
